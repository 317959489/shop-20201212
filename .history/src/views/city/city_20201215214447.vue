<template>
  <div class="van_index_tab">
    ...
    <van-index-bar>
      <div>当前城市</div>
      <van-row class="now1city">
        <div class="ncson">重庆</div>
      </van-row>
      <div>热门城市</div>
      <van-row class="nowcity">
        <div class="ncson">北京</div>
        <div class="ncson">上海</div>
        <div class="ncson">杭州</div>
        <div class="ncson">重庆</div>
        <div class="ncson">成都</div>
        <div class="ncson">厦门</div>
      </van-row>
